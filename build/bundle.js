var app = (function () {
    ...
    /* src\components\HowTo.svelte generated by Svelte v3.46.4 */
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="handwashing.gif" alt="a chart showing the individual steps for proper hand washing" class="svelte-1n7ffp3"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    /* src\components\ProgressBar.svelte generated by Svelte v3.46.4 */
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-ra2nl0");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-ra2nl0");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    /* src\components\Timer.svelte generated by Svelte v3.46.4 */
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h2, "class", "svelte-xw3maw");
    			attr(div0, "bp", "grid");
    			button.disabled = /*isRunning*/ ctx[1];
    			attr(button, "class", "start svelte-xw3maw");
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(button, "click", /*countdown*/ ctx[3]);
    				mounted = true;
    			}
    		},
    		p(ctx, [dirty]) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [secondsLeft, isRunning, progress, countdown];
    }
    ...
    function create_fragment(ctx) {
    	...
    	let current;
    	timer = new Timer({});
    	timer.$on("end", /*timerEnd*/ ctx[1]);
    	howto = new HowTo({});

    	return {
    		c() {
    			h1 = element("h1");
    			h1.textContent = "Handwashing Countdown";
    			t1 = space();
    			...
    			t3 = space();
    			p0 = element("p");
    			p0.innerHTML = `<a href="https://www.who.int/teams/integrated-health-services/infection-prevention-control">Image Source: World Health Organization</a>`;
    			t5 = space();
    			p1 = element("p");
    			p1.innerHTML = `<a href="https://freesound.org/people/metrostock99/sounds/345086/">Sound Source: Freesound.org</a>`;
    			t7 = space();
    			audio_1 = element("audio");
    			audio_1.innerHTML = `<source src="sound.wav"/>`;
    			attr(h1, "class", "svelte-2a9y0f");
    			attr(p0, "class", "svelte-2a9y0f");
    			attr(p1, "class", "svelte-2a9y0f");
    		},
    		m(target, anchor) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [audio, timerEnd, audio_1_binding];
    }
